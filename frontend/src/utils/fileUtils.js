...
export const ALLOWED_FILE_TYPES = {
  // Documents
  'application/pdf': { ext: 'pdf', category: 'document', maxSize: 50 * 1024 * 1024 }, // 50MB
  'application/msword': { ext: 'doc', category: 'document', maxSize: 25 * 1024 * 1024 }, // 25MB
  'application/vnd.openxmlformats-officedocument.wordprocessingml.document': { ext: 'docx', category: 'document', maxSize: 25 * 1024 * 1024 }, // 25MB
  'text/plain': { ext: 'txt', category: 'document', maxSize: 5 * 1024 * 1024 }, // 5MB
  
  // Images
  'image/jpeg': { ext: 'jpg', category: 'image', maxSize: 10 * 1024 * 1024 }, // 10MB
  'image/jpg': { ext: 'jpg', category: 'image', maxSize: 10 * 1024 * 1024 }, // 10MB
  'image/png': { ext: 'png', category: 'image', maxSize: 10 * 1024 * 1024 }, // 10MB
  'image/gif': { ext: 'gif', category: 'image', maxSize: 5 * 1024 * 1024 }, // 5MB
  'image/webp': { ext: 'webp', category: 'image', maxSize: 10 * 1024 * 1024 }, // 10MB
  
  // Videos
  'video/mp4': { ext: 'mp4', category: 'video', maxSize: 500 * 1024 * 1024 }, // 500MB
  'video/avi': { ext: 'avi', category: 'video', maxSize: 500 * 1024 * 1024 }, // 500MB
  'video/quicktime': { ext: 'mov', category: 'video', maxSize: 500 * 1024 * 1024 }, // 500MB
  'video/x-msvideo': { ext: 'avi', category: 'video', maxSize: 500 * 1024 * 1024 }, // 500MB
  
  // Audio
  'audio/mpeg': { ext: 'mp3', category: 'audio', maxSize: 50 * 1024 * 1024 }, // 50MB
  'audio/wav': { ext: 'wav', category: 'audio', maxSize: 100 * 1024 * 1024 }, // 100MB
  'audio/mp4': { ext: 'm4a', category: 'audio', maxSize: 50 * 1024 * 1024 }, // 50MB
  
  // Archives
  'application/zip': { ext: 'zip', category: 'archive', maxSize: 100 * 1024 * 1024 }, // 100MB
  'application/x-rar-compressed': { ext: 'rar', category: 'archive', maxSize: 100 * 1024 * 1024 }, // 100MB
  
  // Spreadsheets
  'application/vnd.ms-excel': { ext: 'xls', category: 'spreadsheet', maxSize: 25 * 1024 * 1024 }, // 25MB
  'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': { ext: 'xlsx', category: 'spreadsheet', maxSize: 25 * 1024 * 1024 } // 25MB
};
