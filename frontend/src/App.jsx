...
const TrainingShowcase = React.lazy(() => import('./features/training/pages/TrainingShowcase.jsx'));
const TrainingHomePage = React.lazy(() => import('./features/training/pages/TrainingHomePage.jsx'));
const AddEditTraining = React.lazy(() => import('./features/training/pages/AddEditTraining.jsx'));
const ViewTraining = React.lazy(() => import('./features/training/pages/ViewTraining.jsx'));
const AboutPage = React.lazy(() => import('./pages/AboutPage.jsx'));
const FarmerDashboard = React.lazy(() => import('./pages/farmerdashboard.jsx'));
const PublicTrainingViewer = React.lazy(() => import('./features/training/pages/PublicTrainingViewer.jsx'));
